            ...
            <div className="interest-content">
                <div className="interest-box">
                    <div className="interest-circle">
                        <img src="/public/static/images/games.jpg" alt="jeux" />
                ...
                <div className="interest-box" id="sport">
                    <div className="interest-circle">
                        <img src="/public/static/images/sport.jpg" alt="sport" />
                ...
                <div className="interest-box" id="music">
                    <div className="interest-circle">
                        <img src="/public/static/images/music.jpg" alt="musique" />
                ...
                <div className="interest-box" id="informatique">
                    <div className="interest-circle">
                        <img src="/public/static/images/informatique.jpg" alt="informatique" />
